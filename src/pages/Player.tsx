...
import PlayerSkeleton from 'components/LoadingSkeletons/PlayerSkeleton';
  ...
  return (
    <div className="container mb-4 px-4 pt-4">
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-5">
        ...
        <Stats stats={player?.stats} isLoading={isLoading} />
        <Rankings stats={player?.stats} isLoading={isLoading} />
